...
🔗 GitHub   : github.com/paraspathania

💪 Core Skills:
  ├─ Java     → OOP · DSA · Streams · Collections
  ├─ JS/TS    → React · Hooks · Redux · Next.js
  ├─ Node.js  → Express · REST · JWT · Websockets
  ├─ Databases→ MySQL · MongoDB · Redis
  └─ DevOps   → Docker · Git · Linux · CI/CD

📖 Currently Learning:
  ├─ Advanced System Design & Architecture
  ├─ FastAPI · Django · ML Integration
  └─ Next.js · SSR · Edge Computing

⚡ Fun Fact  : I debug at midnight and call it
               "digital archaeology" 🦕 ☕
```
...
<table>
  ...
  <tr>
    ...
    <td>
      <img src="https://skillicons.dev/icons?i=mysql,mongodb,redis,postgresql&theme=dark"/>
    </td>
  </tr>
  <tr>
...
| 🔭 Domain | 🎯 Working On | 📈 Progress |
|:---|:---|:---:|
| ⚛️ **React Ecosystem** | Advanced Hooks · Next.js · Performance Tuning | `█████████░` **90%** |
| 🧠 **DSA & Algorithms** | Trees · Graphs · Dynamic Programming | `████████░░` **80%** |
| 🐳 **DevOps & Cloud** | Docker · CI/CD · Cloud Deployments | `███████░░░` **70%** |
| 🐍 **Python Backend** | FastAPI · Django REST · ML Integration | `██████░░░░` **60%** |
| 🏗️ **System Design** | Microservices · Caching · Scalability | `█████░░░░░` **50%** |
...
| 🟢 **Backend** | Node.js · Express · FastAPI · REST APIs · JWT · WebSockets |
| 🟡 **Databases** | MySQL · MongoDB · Redis · Schema Design · Query Optimization |
| 🔴 **CS Fundamentals** | DSA · System Design · OOP · SOLID Principles · Design Patterns |
| ⚪ **DevOps** | Git · Docker · Linux · GitHub Actions · CI/CD Pipelines |
